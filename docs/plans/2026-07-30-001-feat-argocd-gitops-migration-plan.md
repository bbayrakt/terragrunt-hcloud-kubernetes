...
- [ ] U5. **Bootstrap Sealed Secrets as the first `platform`-tier app**
...
- [ ] U6. **Migrate `gha-runner-scale-set-controller` to the `platform` tier**
...
- [ ] U7. **Migrate `gha-runner-scale-set` to the `apps` tier, re-homing `github-arc-pat`**
